...
public abstract class GenericService extends Service {
	...
	private static final String TAG = "Bereshtook.Service";
	private static final String APP_NAME = "Bereshtook";
	...
	protected BereshtookConfiguration mConfig;
	...
	public void onCreate() {
		...
		super.onCreate();
		mConfig = ir.bereshtook.androidclient.BereshtookApplication.getConfig(this);
