...
public class BereshtookBroadcastReceiver extends BroadcastReceiver {
	static final String TAG = "Bereshtook.BroadcastReceiver";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(Intent.ACTION_SHUTDOWN)) {
			Log.d(TAG, "System shutdown, stopping Bereshtook.");
