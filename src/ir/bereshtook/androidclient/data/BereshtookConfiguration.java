package ir.bereshtook.androidclient.data;
...
import ir.bereshtook.androidclient.util.XMPPHelper;

import java.util.Arrays;
import java.util.HashSet;

public class BereshtookConfiguration implements OnSharedPreferenceChangeListener {

	private static final String TAG = "Bereshtook.Configuration";
	...
	public BereshtookConfiguration(SharedPreferences _prefs) {
		prefs = _prefs;
	...
	private void loadPrefs(SharedPreferences prefs) {
		...
		this.ressource = prefs
				.getString(PreferenceConstants.RESSOURCE, "Bereshtook");
